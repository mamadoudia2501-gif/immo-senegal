  ...
  static ThemeData light() {
    final scheme =
        ColorScheme.fromSeed(
          ...
          onSecondaryContainer: const Color(0xFF6B2E12),
          tertiaryContainer: const Color(0xFFF6E7C1),
          onTertiaryContainer: const Color(0xFF6B4E10),
          surface: AppColors.cream,
          surfaceContainerHighest: const Color(0xFFEFE6D8),
